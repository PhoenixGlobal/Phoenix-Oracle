...
The API includes rate limiting. The API allows 2,000 requests per day and 100 requests per hour.

## Authentication

The API requires authentication. To use the API, you must include an API key when loading the API. Please note this feature is disabled by default when running the API locally.
