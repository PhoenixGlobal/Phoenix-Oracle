...
func (ec *explorerClient) connect(ctx context.Context) error {
	...
	authHeader.Add("X-Explore-Phoenix-Accesskey", ec.accessKey)
	authHeader.Add("X-Explore-Phoenix-Secret", ec.secret)
	authHeader.Add("X-Explore-Phoenix-Core-Version", static.Version)
	authHeader.Add("X-Explore-Phoenix-Core-Sha", static.Sha)
