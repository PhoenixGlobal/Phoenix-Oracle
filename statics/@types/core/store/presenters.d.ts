declare module 'core/store/presenters' {
  ...
  /**
   * AccountBalance holds the hex representation of the address plus it's ETH & PHB balances
   */
  export interface AccountBalance {
    address: string
    ethBalance: Pointer<assets.Eth>
    phbBalance: Pointer<assets.Link>
    createdAt: string
    isFunding: boolean
  }
  ...
  interface EnvPrinter {
    ...
    phoenixDev: boolean
    phoenixPort: number
    phoenixTLSHost: string
    phoenixTLSPort: number
