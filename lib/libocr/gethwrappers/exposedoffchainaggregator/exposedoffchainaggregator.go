...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorCaller) GetPhbToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ExposedOffchainAggregator.contract.Call(opts, &out, "getPhbToken")
...
//
// Solidity: function getPhbToken() view returns(address phbToken)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorSession) GetPhbToken() (common.Address, error) {
	return _ExposedOffchainAggregator.Contract.GetPhbToken(&_ExposedOffchainAggregator.CallOpts)
}

// GetPhbToken is a free data retrieval call binding the contract method 0xe76d5168.
//
// Solidity: function getPhbToken() view returns(address phbToken)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorCallerSession) GetPhbToken() (common.Address, error) {
	return _ExposedOffchainAggregator.Contract.GetPhbToken(&_ExposedOffchainAggregator.CallOpts)
}
...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorCaller) PhbAvailableForPayment(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ExposedOffchainAggregator.contract.Call(opts, &out, "phbAvailableForPayment")
...
//
// Solidity: function phbAvailableForPayment() view returns(int256 availableBalance)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorSession) PhbAvailableForPayment() (*big.Int, error) {
	return _ExposedOffchainAggregator.Contract.PhbAvailableForPayment(&_ExposedOffchainAggregator.CallOpts)
}

// PhbAvailableForPayment is a free data retrieval call binding the contract method 0xd09dc339.
//
// Solidity: function phbAvailableForPayment() view returns(int256 availableBalance)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorCallerSession) PhbAvailableForPayment() (*big.Int, error) {
	return _ExposedOffchainAggregator.Contract.PhbAvailableForPayment(&_ExposedOffchainAggregator.CallOpts)
}
...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorTransactor) SetBilling(opts *bind.TransactOpts, _maximumGasPrice uint32, _reasonableGasPrice uint32, _microPhbPerEth uint32, _phbGweiPerObservation uint32, _phbGweiPerTransmission uint32) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.contract.Transact(opts, "setBilling", _maximumGasPrice, _reasonableGasPrice, _microPhbPerEth, _phbGweiPerObservation, _phbGweiPerTransmission)
}

// SetBilling is a paid mutator transaction binding the contract method 0xbd824706.
//
// Solidity: function setBilling(uint32 _maximumGasPrice, uint32 _reasonableGasPrice, uint32 _microPhbPerEth, uint32 _phbGweiPerObservation, uint32 _phbGweiPerTransmission) returns()
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorSession) SetBilling(_maximumGasPrice uint32, _reasonableGasPrice uint32, _microPhbPerEth uint32, _phbGweiPerObservation uint32, _phbGweiPerTransmission uint32) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.Contract.SetBilling(&_ExposedOffchainAggregator.TransactOpts, _maximumGasPrice, _reasonableGasPrice, _microPhbPerEth, _phbGweiPerObservation, _phbGweiPerTransmission)
}

// SetBilling is a paid mutator transaction binding the contract method 0xbd824706.
//
// Solidity: function setBilling(uint32 _maximumGasPrice, uint32 _reasonableGasPrice, uint32 _microPhbPerEth, uint32 _phbGweiPerObservation, uint32 _phbGweiPerTransmission) returns()
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorTransactorSession) SetBilling(_maximumGasPrice uint32, _reasonableGasPrice uint32, _microPhbPerEth uint32, _phbGweiPerObservation uint32, _phbGweiPerTransmission uint32) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.Contract.SetBilling(&_ExposedOffchainAggregator.TransactOpts, _maximumGasPrice, _reasonableGasPrice, _microPhbPerEth, _phbGweiPerObservation, _phbGweiPerTransmission)
}
...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorTransactor) SetPhbToken(opts *bind.TransactOpts, _phbToken common.Address, _recipient common.Address) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.contract.Transact(opts, "setPhbToken", _phbToken, _recipient)
}

// SetPhbToken is a paid mutator transaction binding the contract method 0x4fb17470.
//
// Solidity: function setPhbToken(address _phbToken, address _recipient) returns()
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorSession) SetPhbToken(_phbToken common.Address, _recipient common.Address) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.Contract.SetPhbToken(&_ExposedOffchainAggregator.TransactOpts, _phbToken, _recipient)
}

// SetPhbToken is a paid mutator transaction binding the contract method 0x4fb17470.
//
// Solidity: function setPhbToken(address _phbToken, address _recipient) returns()
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorTransactorSession) SetPhbToken(_phbToken common.Address, _recipient common.Address) (*types.Transaction, error) {
	return _ExposedOffchainAggregator.Contract.SetPhbToken(&_ExposedOffchainAggregator.TransactOpts, _phbToken, _recipient)
}
...
// ExposedOffchainAggregatorPhbTokenSetIterator is returned from FilterPhbTokenSet and is used to iterate over the raw logs and unpacked data for PhbTokenSet events raised by the ExposedOffchainAggregator contract.
type ExposedOffchainAggregatorPhbTokenSetIterator struct {
	Event *ExposedOffchainAggregatorPhbTokenSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExposedOffchainAggregatorPhbTokenSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExposedOffchainAggregatorPhbTokenSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExposedOffchainAggregatorPhbTokenSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExposedOffchainAggregatorPhbTokenSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ExposedOffchainAggregatorPhbTokenSet represents a PhbTokenSet event raised by the ExposedOffchainAggregator contract.
type ExposedOffchainAggregatorPhbTokenSet struct {
...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorFilterer) FilterPhbTokenSet(opts *bind.FilterOpts, _oldPhbToken []common.Address, _newPhbToken []common.Address) (*ExposedOffchainAggregatorPhbTokenSetIterator, error) {
	...
	logs, sub, err := _ExposedOffchainAggregator.contract.FilterLogs(opts, "PhbTokenSet", _oldPhbTokenRule, _newPhbTokenRule)
	if err != nil {
		return nil, err
	}
	return &ExposedOffchainAggregatorPhbTokenSetIterator{contract: _ExposedOffchainAggregator.contract, event: "PhbTokenSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event PhbTokenSet(address indexed _oldPhbToken, address indexed _newPhbToken)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorFilterer) WatchPhbTokenSet(opts *bind.WatchOpts, sink chan<- *ExposedOffchainAggregatorPhbTokenSet, _oldPhbToken []common.Address, _newPhbToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ExposedOffchainAggregator.contract.WatchLogs(opts, "PhbTokenSet", _oldPhbTokenRule, _newPhbTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExposedOffchainAggregatorPhbTokenSet)
				if err := _ExposedOffchainAggregator.contract.UnpackLog(event, "PhbTokenSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event PhbTokenSet(address indexed _oldPhbToken, address indexed _newPhbToken)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorFilterer) ParsePhbTokenSet(log types.Log) (*ExposedOffchainAggregatorPhbTokenSet, error) {
	event := new(ExposedOffchainAggregatorPhbTokenSet)
	if err := _ExposedOffchainAggregator.contract.UnpackLog(event, "PhbTokenSet", log); err != nil {
		return nil, err
	}
...
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorFilterer) FilterOraclePaid(opts *bind.FilterOpts, transmitter []common.Address, payee []common.Address, phbToken []common.Address) (*ExposedOffchainAggregatorOraclePaidIterator, error) {
	...
	logs, sub, err := _ExposedOffchainAggregator.contract.FilterLogs(opts, "OraclePaid", transmitterRule, payeeRule, phbTokenRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event OraclePaid(address indexed transmitter, address indexed payee, uint256 amount, address indexed phbToken)
func (_ExposedOffchainAggregator *ExposedOffchainAggregatorFilterer) WatchOraclePaid(opts *bind.WatchOpts, sink chan<- *ExposedOffchainAggregatorOraclePaid, transmitter []common.Address, payee []common.Address, phbToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ExposedOffchainAggregator.contract.WatchLogs(opts, "OraclePaid", transmitterRule, payeeRule, phbTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
