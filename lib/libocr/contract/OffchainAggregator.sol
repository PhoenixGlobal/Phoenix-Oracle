...
contract OffchainAggregator is Owned, OffchainAggregatorBilling, AggregatorV2V3Interface, TypeAndVersionInterface {
  ...
  struct HotVars {
    ...
    uint8 threshold;
    // Phoenix Aggregators expose a roundId to consumers. The offchain reporting
   ...
   * @param _phb address of the PHB contract
  ...
  constructor(
    ...
    OffchainAggregatorBilling(_maximumGasPrice, _reasonableGasPrice, _microPhbPerEth,
      _phbGweiPerObservation, _phbGweiPerTransmission, _phb,
