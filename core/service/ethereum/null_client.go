...
func (nc *NullClient) GetPHBBalance(phbAddress common.Address, address common.Address) (*assets.Phb, error) {
	logger.Debug("NullClient#GetPHBBalance")
	return assets.NewPhb(0), nil
}
