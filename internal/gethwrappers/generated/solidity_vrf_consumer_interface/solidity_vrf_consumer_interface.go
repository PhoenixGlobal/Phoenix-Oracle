...
func DeployVRFConsumer(auth *bind.TransactOpts, backend bind.ContractBackend, _vrfCoordinator common.Address, _phb common.Address) (common.Address, *types.Transaction, *VRFConsumer, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(VRFConsumerBin), backend, _vrfCoordinator, _phb)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
