...
type ConfigSchema struct {
	...
	Dev                                        bool            `env:"PHOENIX_DEV" default:"false"`
	...
	PhbContractAddress                   string                        `env:"PHB_CONTRACT_ADDRESS"`
	...
	MinimumContractPayment                assets.Phb                   `env:"MINIMUM_CONTRACT_PAYMENT_PHB_JUELS"`
	...
	TLSHost                               string                        `env:"PHOENIX_TLS_HOST" `
	TLSKeyPath                            string                        `env:"TLS_KEY_PATH" `
	TLSPort                               uint16                        `env:"PHOENIX_TLS_PORT" default:"6689"`
	TLSRedirect                           bool                          `env:"PHOENIX_TLS_REDIRECT" default:"false"`
